        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              L'élégance en or 18K – Bijoux et montres de luxe livrés partout au
              Maroc
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/boutique?categorie=colliers"
                  className="text-gray-400 hover:text-amber-500"
                >
                  Colliers
                </Link>
              ...
              <li>
                <Link
                  to="/boutique?categorie=bracelets"
                  className="text-gray-400 hover:text-amber-500"
                >
                  Bracelets
                </Link>
              ...
              <li>
                <Link
                  to="/boutique?categorie=boucles-oreilles"
                  className="text-gray-400 hover:text-amber-500"
                >
                  Boucles d'oreilles
                </Link>
